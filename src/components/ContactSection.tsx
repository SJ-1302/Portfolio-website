...
export function ContactSection() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      await emailjs.send(
        'service_kcc0jfx',      // Replace with your EmailJS Service ID
        'template_nnc182n',     // Replace with your EmailJS Template ID
        {
          from_name: formData.name,
          from_email: formData.email,
          message: formData.message,
          to_email: 'shreyanshjain.cse@gmail.com',
        },
        'A1hxjK6paeKYKbdYF'       // Replace with your EmailJS Public Key
      );
  ...
  const contactInfo = [
    {
      icon: Mail,
      label: 'Email',
      value: 'shreyanshjain.cse@gmail.com',
      link: 'mailto:shreyanshjain.cse@gmail.com',
    },
    {
      icon: Phone,
      label: 'Contact',
      value: '+91 7827673166',
      link: 'tel:+917827673166',
    },
    {
      icon: MessageCircle,
      label: 'WhatsApp',
      value: 'Chat on WhatsApp',
      link: 'https://wa.me/917827673166',
    },
    {
      icon: Github,
      label: 'GitHub',
      value: 'github.com/SJ-1302',
      link: 'https://github.com/SJ-1302',
    },
    {
      icon: Linkedin,
      label: 'LinkedIn',
      value: 'linkedin.com/in/shreyanshjain13',
      link: 'https://www.linkedin.com/in/shreyanshjain13/',
    },
  ];
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              <div className="p-8 rounded-xl bg-gradient-to-br from-white/5 to-white/10 border border-white/10 backdrop-blur-sm space-y-6">
                ...
                <Button
                  type="submit"
                  disabled={isSubmitting}
                  className="w-full bg-gradient-to-r from-primary to-accent hover:shadow-[0_0_30px_rgba(0,212,255,0.5)] transition-all duration-300 text-[#0f0f10] disabled:opacity-50 disabled:cursor-not-allowed"
                >
