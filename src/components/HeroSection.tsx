...
const roles = ['Quant Strategist', 'Software Engineer', 'Algorithmic Trader', 'Quant Researcher'];
      ...
      <div className="relative z-10 max-w-7xl mx-auto w-full">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            <div className="space-y-4">
              ...
              >
                <h1 className="text-6xl md:text-7xl lg:text-8xl leading-tight">
                  <span className="block text-foreground">Shreyansh</span>
            ...
            >
              Building the future at the intersection of Quantitative Finance and Artificial Intelligence. 
              Specializing in Algorithmic trading systems, Predictive ML models, and High-performance Software engineering. 
            </motion.p>
